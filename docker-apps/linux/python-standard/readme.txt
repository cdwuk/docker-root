...
# docker container run --name python-web-app --rm -i -t -p 5001:5000 cdwuk/python-standard:latest
...
docker push cdwuk/python-standard:latest
...
# Select Container Settings - edit the image to cdwuk/python-standard:v1.0.0 image in Docker Hub
...
# now deploy the cdwuk/python-standard:v1.0.0 web server image from Docker Hub into your kubernetes cluster
